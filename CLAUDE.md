# AppointmentFlowOptimizer Agentic Scheduler — Project Memory
...
A **final-round interview take-home** for **the practice management system** (dental SaaS). Scott is a TypeScript
...
- Git: local repo initialized on `main`, remote connected to
  `https://github.com/srfinch17/peckworks-appointmentflowoptimizer.git`. Commits NOT pushed yet
