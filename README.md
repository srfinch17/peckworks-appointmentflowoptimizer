...
schedule. Built for the the practice management system take-home (Assignment 2).
...
- The schedule lives behind a **`ScheduleStore` interface** (JSON today; Google
  Calendar / an EHR / the practice management system's own DB is a drop-in replacement).
